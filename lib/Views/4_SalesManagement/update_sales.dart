...
class _UpdateSalesState extends State<UpdateSales> {
  ...
  Widget build(BuildContext context) {
    ...
    fatura_tarihi.text = Calculator.dateTimeToString(
        Calculator.timeStampToDateTime(widget.sales.fatura_tarihi));
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    controller: ili,
                    decoration: const InputDecoration(
                        hintText: "İli", icon: Icon(Icons.add_location_sharp)),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
